 ...
 */
export function rankPlaces(places, month, origin, currentLocation = null) {
  return places.map((place) => {
    ...
    return { ...place, driveMinutes, distanceKm:straightKm, score, reason };
  }).sort((a,b) => b.score - a.score || (a.distanceKm ?? a.driveMinutes) - (b.distanceKm ?? b.driveMinutes));
}
