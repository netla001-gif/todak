...
type Place = {
  ...
  image: string; description: string; facts: string[]; highlights: string[]; drive: Record<string, number>; url: string;
};
...
const places: Place[] = [
  ...
  { id:"imom-seongnae", title:"아이맘강동 성내1동점", district:"강동구", category:"indoor", minMonth:6, maxMonth:48, price:"2,000원", convenience:.96, image:"https://images.pexels.com/photos/5865565/pexels-photo-5865565.jpeg?auto=compress&fit=crop&w=1200&h=760", description:"영유아가 보호자와 함께 안전하게 움직이고 놀 수 있는 공공형 실내놀이터예요.", facts:["예약제","실내","영유아 맞춤"], highlights:["회차제 예약(하루 3회), 아동 2,000원·보호자 무료","24개월 미만 전용 영유아 존과 오두막 트리하우스, AR 트램펄린 존이 있어요","미끄럼방지 양말 필수, 놀이공간 내 음식은 금지예요(간식은 수유실에서)"], drive:{강동구청:4,천호동:7,암사동:11,고덕동:15,상일동:18}, url:"https://gangdong.go.kr/web/newportal/contents/gdp_005_001_005_007_004" },
  { id:"imom-godeok", title:"아이맘강동 고덕2동점", district:"강동구", category:"indoor", minMonth:6, maxMonth:48, price:"2,000원", convenience:.94, image:"https://images.pexels.com/photos/8613089/pexels-photo-8613089.jpeg?auto=compress&fit=crop&w=1200&h=760", description:"비 오는 날에도 부담 없이 갈 수 있는 소규모 서울형 키즈카페예요.", facts:["예약제","실내","보호자 동반"], highlights:["회차제 예약(하루 3회), 아동 2,000원·보호자 무료, 1건당 영유아 최대 3인","미끄럼방지 양말 필수, 놀이공간 내 음식은 금지예요(간식은 수유실에서)","예약은 아이맘강동 홈페이지 또는 우리동네키움포털에서 온라인으로 해요"], drive:{강동구청:15,천호동:18,암사동:12,고덕동:5,상일동:8}, url:"https://gangdong.go.kr/web/newportal/contents/gdp_005_001_005_007_004" },
  { id:"amsa-prehistory", title:"서울 암사동 유적", district:"강동구", category:"outdoor", minMonth:18, maxMonth:48, price:"무료", convenience:.76, image:"https://images.pexels.com/photos/29631068/pexels-photo-29631068.jpeg?auto=compress&fit=crop&w=1200&h=760", description:"선사시대 움집과 넓은 야외 공간을 함께 둘러보는 가벼운 역사 나들이예요.", facts:["박물관","야외","체험 프로그램"], highlights:["체험 움집에서 그물·토기 만들기 등 신석기 생활을 간접 체험해요","발굴체험장·어로체험장·수렵체험장·불피우기체험장에서 직접 손으로 체험해요","입장료 어른 500원·어린이 300원, 09:30~18:00(월요일 휴관)"], drive:{강동구청:10,천호동:9,암사동:5,고덕동:12,상일동:16}, url:"https://sunsa.gangdong.go.kr/" },
  ...
  { id:"songpa-book", title:"송파책박물관 북키움", district:"송파구", category:"indoor", minMonth:18, maxMonth:48, price:"무료", convenience:.9, image:"https://images.pexels.com/photos/33744867/pexels-photo-33744867/free-photo-of-cute-child-reading-in-a-vibrant-library-setting.jpeg?auto=compress&fit=crop&w=1200&h=760", description:"그림책 속 이야기를 몸으로 경험하는 어린이 책문화 체험 공간이에요.", facts:["실내","책놀이","회차 운영"], highlights:["명작동화 테마 5개 존(무서운·행복한·신나는·신비한 동화마을 등) 체험형 전시예요","하루 3회 시간제 예약제(회차당 60명), 보호자 포함 전원 사전 온라인 예약 필수예요","공식 권장연령은 5~7세라 어린 영아보다는 3~4세 이상에 더 잘 맞아요"], drive:{강동구청:18,천호동:16,암사동:21,고덕동:27,상일동:29}, url:"https://www.bookmuseum.go.kr/exhibit/exhibit_book_info.do" },
  { id:"seoul-children-museum", title:"서울상상나라 아기놀이터", district:"광진구", category:"indoor", minMonth:6, maxMonth:48, price:"36개월 미만 무료", convenience:.92, image:"https://images.pexels.com/photos/8613313/pexels-photo-8613313.jpeg?auto=compress&fit=crop&w=1200&h=760", description:"월령별 발달을 고려한 신체·감각·상상 놀이를 한 공간에서 경험해요.", facts:["사전예약","실내","아기놀이터"], highlights:["36개월 미만 전용 공간으로 그림책 교감존·촉감놀이 꼼지락방·걸음마 연습존 등 5개 존이 있어요","인터넷 예약제, 회당 최대 7명씩 하루 2회 운영돼요","영유아 2명당 보호자 1인 동반이 필수예요"], drive:{강동구청:22,천호동:18,암사동:20,고덕동:24,상일동:28}, url:"https://www.seoulchildrensmuseum.org/reservation/viewAdmission.do" },
  { id:"hanam-union", title:"하남유니온파크", district:"하남시", category:"outdoor", minMonth:10, maxMonth:48, price:"무료", convenience:.78, image:"https://images.pexels.com/photos/1173777/pexels-photo-1173777.jpeg?auto=compress&fit=crop&w=1200&h=760", description:"잔디광장과 생태연못을 가볍게 걷고 전망타워까지 둘러볼 수 있어요.", facts:["잔디광장","생태연못","전망대"], highlights:["잔디광장·생태연못·야외공연장을 갖춘 복합공원이고 어린이 물놀이시설도 있어요","105m 높이 유니온타워 전망대 4층에서 한강·검단산을 조망할 수 있어요"], drive:{강동구청:19,천호동:23,암사동:18,고덕동:14,상일동:12}, url:"https://www.hanam.go.kr/DATA/newsletter/3902/20260107104038747_rjZx.pdf" }
  ,{ id:"imom-cheonho", title:"아이맘강동 천호2동점", district:"강동구", category:"indoor", minMonth:6, maxMonth:48, price:"2,000원", convenience:.94, image:"https://images.pexels.com/photos/5865565/pexels-photo-5865565.jpeg?auto=compress&fit=crop&w=1200&h=760", description:"천호동에서 가까운 공동육아방으로 영유아와 보호자가 함께 놀기 좋아요.", facts:["예약제","실내","화~토 운영"], highlights:["회차제 예약(하루 3회), 아동 2,000원·보호자 무료, 1건당 영유아 최대 3인","미끄럼방지 양말 필수, 놀이공간 내 음식은 금지예요(간식은 수유실에서)","예약은 아이맘강동 홈페이지에서 온라인으로 해요"], drive:{강동구청:7,천호동:3,암사동:8,고덕동:16,상일동:20}, url:"https://gangdong.go.kr/web/newportal/contents/gdp_005_001_005_007_004" }
  ...
  ,{ id:"imom-sangil-2", title:"아이맘강동 상일2동 2호점", district:"강동구", category:"indoor", minMonth:6, maxMonth:48, price:"2,000원", convenience:.92, image:"https://images.pexels.com/photos/33744867/pexels-photo-33744867/free-photo-of-cute-child-reading-in-a-vibrant-library-setting.jpeg?auto=compress&fit=crop&w=1200&h=760", description:"상일2동 주민센터 안에 있어 가까운 실내 나들이로 선택하기 좋아요.", facts:["예약제","실내","주민센터 3층"], highlights:["회차제 예약(하루 3회), 아동 2,000원·보호자 무료","24개월 이상 유아 전용관으로 흔들흔들 징검다리 존과 공룡 테마 라이브스케치 존이 있어요","미끄럼방지 양말 필수, 놀이공간 내 음식은 금지예요(간식은 수유실에서)"], drive:{강동구청:18,천호동:21,암사동:17,고덕동:9,상일동:4}, url:"https://gangdong.go.kr/web/newportal/contents/gdp_005_001_005_007_004" }
  ...
  ,{ id:"misa-lake", title:"미사호수공원", district:"하남시", category:"outdoor", minMonth:6, maxMonth:48, price:"무료", convenience:.85, image:"https://images.pexels.com/photos/1173777/pexels-photo-1173777.jpeg?auto=compress&fit=crop&w=1200&h=760", description:"호수 산책로와 잔디광장, 휴식 공간이 있어 가벼운 가족 나들이에 잘 맞아요.", facts:["호수 산책","잔디광장","유모차"], highlights:["호수를 한 바퀴 도는 호수길(약 1km)과 수변 산책로 6.4km가 있어요","바닥분수·음악분수·물놀이장·잔디광장 등 시설이 있어요","유모차 대여는 없어서 직접 가져가야 해요"], drive:{강동구청:24,천호동:28,암사동:21,고덕동:17,상일동:14}, url:"https://www.hanam.go.kr/cleanh/cleanhBbsNttWebView.do?key=4348&nttNo=3325" }
  ...
  ,{ id:"guri-insect", title:"구리 곤충생태관", district:"구리시", category:"indoor", minMonth:18, maxMonth:48, price:"무료", convenience:.82, image:"https://images.pexels.com/photos/8613313/pexels-photo-8613313.jpeg?auto=compress&fit=crop&w=1200&h=760", description:"나비관과 곤충관, 표본전시실에서 다양한 곤충과 수생식물을 가까이 관찰해요.", facts:["실내","나비관","생태관찰"], highlights:["사계절 유리온실 나비관에서 나비와 수서곤충을 사시사철 관찰할 수 있어요","곤충관엔 장수풍뎅이·애벌레·사슴벌레 등 살아있는 곤충이 전시돼 있어요","무료 입장·무료 주차, 실내라 비 오는 날이나 더운 날에도 괜찮아요"], drive:{강동구청:27,천호동:24,암사동:20,고덕동:25,상일동:27}, url:"https://www.guri.go.kr/culture/selectTourCntntsWebView.do?ctgry=7&key=1194&pageIndex=1&pageUnit=1000&searchCnd=all&sortTy=RECOMEND&tourNo=125" }
  ,{ id:"guri-forge", title:"고구려대장간마을", district:"구리시", category:"outdoor", minMonth:24, maxMonth:48, price:"무료", convenience:.7, image:"https://images.pexels.com/photos/29631068/pexels-photo-29631068.jpeg?auto=compress&fit=crop&w=1200&h=760", description:"산자락에 재현된 고구려 마을과 대장간을 걸으며 색다른 풍경을 만나요.", facts:["역사체험","야외","경사진 길"], highlights:["산자락 경사지형이라 유모차·휠체어 이용은 어려워요","물레방아가 도는 대장간과 고구려 마을을 재현한 야외 체험장이에요","와당 만들기, 활 체험 등 체험 프로그램이 있어요(일부 사전예약 필요), 무료 관람"], drive:{강동구청:22,천호동:19,암사동:15,고덕동:20,상일동:23}, url:"https://www.guri.go.kr/gbv/contents.do?key=1604" }
  ...
  ,{ id:"guri-donggureung", title:"구리 동구릉", district:"구리시", category:"outdoor", minMonth:18, maxMonth:48, price:"만 6세 이하 무료", convenience:.75, image:"https://images.pexels.com/photos/27176993/pexels-photo-27176993/free-photo-of-happy-family-picnic-in-the-park.jpeg?auto=compress&fit=crop&w=1200&h=760", description:"숲길과 넓은 능역을 따라 아이와 조용히 걷기 좋은 세계유산 산책 코스예요.", facts:["숲길","역사산책","주차"], highlights:["경릉~양묘장 숲길 왕복 1.5km로 경사가 완만해 유모차로도 부담 없어요","유모차 대여 시설이 있어요(봉분 위 출입은 금지)","하절기 06:00~18:00, 동절기 06:30~17:30 운영해요"], drive:{강동구청:31,천호동:28,암사동:24,고덕동:29,상일동:31}, url:"https://www.guri.go.kr/culture/index.do" }
];
